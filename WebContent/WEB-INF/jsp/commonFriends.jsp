				...
				<div class="entry-content">
					...
					<div style="width: 100%; padding-left: 5%; padding-right: 5%;">
						...
						<c:forEach var="x" items="${user.getSelectedFriends()}">
							<div
								style="float: left; width: 30%; text-align: left; padding-left: 3%; height: 100px; overflow: scroll;">
								<img class="circular" style="height: 30px;"
									src="${x.getPicture() }"> <b>${x.getName()}</b>

								<c:forEach var="y" items="${x.getSelectedCommonFriends(user.getSelectedFriends())}">
									<div
										style="float: left; width: 90%; text-align: left; padding-left: 10%">
										<img class="circular" style="height: 20px;"
											src="${y.getPicture() }">
										<c:out value="${y.getName()}" />
									</div>
								</c:forEach>
						...
						<form action="/FacebookAnalytics/user/commonFriends/graph">
							<div class="mask2"
								style="width: 50%; text-align: center; float: left; clear: left; padding-top: 10px">
								<a href="/FacebookAnalytics/user"> <img type="image"
									src="resources/img/back.png"></a>
							</div>
							<div class="mask2"
								style="width: 50%; text-align: center; float: left; padding-top: 10px">
