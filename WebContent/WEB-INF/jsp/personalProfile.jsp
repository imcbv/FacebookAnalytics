	...
	<div class="container">
		...
		<div class="row">
			<div
				...
				<b>User ID:</b> ${user.getUid()}<br> <b>Location:</b>
				${user.getLocation()}<br> <b>Nickname:</b>
				${user.getUsername()}<br> <b>Gender:</b> ${user.getGender()}<br>
				<b>Link:</b> <a href="${user.getLink()}">${user.getLink()}</a><br>
			</div>
			<div style="float: left; width: 50%; text-align: left; clear: right;"
				...
				<div class="entry-content">
					...
					<form action="user/friendList" method="POST">
						<div class="mask2" style="margin-right: 25px; float: left;">
							<input type="image" src="resources/img/getFriends.png">
						</div>
					</form>

					<form action="<c:url value="/connect/facebook" />" method="POST">
						<div class="mask2" style="margin-right: 25px; float: left;">
							<input type="image" src="resources/img/disconnect.png"> <input
